...
class Patient(models.Model):
    ...
    exam_status = models.CharField(verbose_name='exam_status', max_length=30, blank=True)
    ...
    deceased_date = models.DateField(verbose_name='deceased_date', blank=True, default=None, null=True)
