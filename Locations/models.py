...
class HouseHold(models.Model):
    ...
    village_name = models.CharField(verbose_name='village_name', max_length=100, blank=True)
    street_name = models.CharField(verbose_name='street_name', max_length=100, blank=True)
    gps = models.CharField(verbose_name='gps', max_length=70)
    availability = models.IntegerField(verbose_name='availability', default=1)
